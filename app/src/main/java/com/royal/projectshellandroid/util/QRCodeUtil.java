...
import com.royal.projectshellandroid.ui.WebActivity;
...
public class QRCodeUtil {
    ...
    private static Bitmap addLogo(@Nullable Bitmap srcBitmap, @Nullable Bitmap logoBitmap, float logoPercent){
        ...
        canvas.drawText(context.getString(R.string.app_name),-scaleWidth*4, -20 ,paint);
        float txtWidth = paint.measureText(contentName);
        canvas.drawText(contentName,srcWidth-txtWidth+2, -20 ,paint);
        return bitmap;
    }
}
